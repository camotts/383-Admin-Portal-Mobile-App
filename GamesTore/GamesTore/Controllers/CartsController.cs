    ...
    public class CartsController : BaseApiController
    {
        ...
        public HttpResponseMessage GetCarts()
        {
            ...
            else if (IsAuthorized(Request, new List<Roles> { Roles.Employee }))
            {
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.NoContent, "No carts available for checkout");
                }
        ...
        {
            if (IsAuthorized(Request, new List<Roles> { Roles.Employee, Roles.Admin }))
            {
            ...
            var carta = db.Carts.FirstOrDefault(c => c.User_Id == id);
            if (carta == null)
            {
                return Request.CreateResponse(HttpStatusCode.NotFound, "Cannot find User's cart");
